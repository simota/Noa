...
|---|---|---|
| **noa** (this repo) | `noa --cols 120 --rows 40 -e <wrapper>` | native `-e` (2026-07; older builds fall back to `$SHELL` = wrapper, auto-detected) |
...
throughput,scroll,latency,startup` (any subset) restricts a run to those axes.
